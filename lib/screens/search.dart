          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                if (_hits.isNotEmpty)
                  _selecting
                      ? IconBtn(Icons.close, tip: '退出选择', onTap: _exitSelect)
                  ...
                  for (var i = 0; i < _filterNames.length; i++)
                    Pressable(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          color: _filter == i ? c.accent : Colors.transparent,
                          borderRadius: BorderRadius.circular(999),
                          border: Border.all(
                              color: _filter == i ? c.accent : c.inkSoft),
                        ),
                        child: Text(_filterNames[i],
                            style: TextStyle(
                                fontSize: S.textSm - 1,
                                color: _filter == i ? Colors.white : c.inkSoft)),
                      ),
                    ),
                ],
              ),
                ...
                children: [
                  Pressable(
                    ...
                    child: Row(
                      children: [
                        Icon(
                          _selected.isNotEmpty && _selected.length == shown.length
                              ? Icons.check_circle
                        ...
                        Text(
                          _selected.length == shown.length ? '取消全选' : '全选',
                  ...
                  IconBtn(Icons.delete_outline, tip: '删除所选',
                      color: c.accent, onTap: _deleteSelected),
                ],
              ),
            ),
          Expanded(
            child: shown.isEmpty
                ...
                : ListView.builder(
                    padding: const EdgeInsets.fromLTRB(S.lg, S.xs, S.lg, S.lg),
                      ...
                      return Padding(
                        ...
                        child: Row(
                          children: [
                                ...
                                onTap: () {
                                  ...
                                  if (it.parentId != 0) {
                                    Navigator.of(context, rootNavigator: true)
                                        .pushNamed('/steps', arguments: it.parentId);
                                  } else {
                                ...
                                child: Row(
                                  children: [
                                    Icon(
                                      ...
                                      size: 18,
                                      color: _selecting
                                          ? (sel ? c.accent : c.inkSoft)
                                          : it.kind == Item.kindIdea
                                              ? c.inkSoft
                                              : (it.done ? c.done : c.accent),
                                    ),
                                    const SizedBox(width: S.sm),
                                    Expanded(
                                      child: Text(
                            ...
                            if (!_selecting)
                              IconBtn(Icons.close, tip: '删除', onTap: () => _deleteOne(it)),
                          ],
                        ),
                      );
                    },
